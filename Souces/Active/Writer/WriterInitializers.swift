...
extension CSVWriter {
    ...
    public static func data<S:Sequence,Sub:Sequence>(rows: S, encoding: String.Encoding = .utf8, configuration: CSV.Configuration = .init()) throws -> Data where S.Element == Sub, Sub.Element == String {
